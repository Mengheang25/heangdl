...
const HISTORY_KEY = "heangdl_history";
...
export function saveHistory(history) {
  try {
    const limit =
      parseInt(localStorage.getItem("heangdl_history_limit"), 10) || 50;
...
export function autoClearExpiredHistory() {
  const retentionDays =
    parseInt(localStorage.getItem("heangdl_history_retention"), 10) || 0;
