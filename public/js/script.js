...
const GITHUB_REPO = "coflyn/HEANG D.L";
...
let customPath = localStorage.getItem("mori_download_path") || "HEANG D.L";
...
let customMusicPath = localStorage.getItem("mori_music_path") || "HEANG D.L/Music";
...
reportBugBtn?.addEventListener("click", () => {
  ...
  const telegramUrl = `https://t.me/mengheang25?text=${text}`;
...
shareAppBtn?.addEventListener("click", async () => {
  ...
  if (window.Capacitor?.isNativePlatform() && Share) {
    await Share.share({
      title: "HEANG D.L App",
      text: lang["share-msg"],
      url: "https://github.com/Mengheang25/heangdl",
